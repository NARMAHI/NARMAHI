...
const Portfolio = () => {
  ...
  const projects = [
    ...
    { title: "Career Path AI", category: "AI Platform", desc: "Intelligent platform mapping customized career trajectories.", fullDesc: "An AI-driven educational platform that analyzes thousands of data points to generate custom career trajectories for students. We integrated advanced LLMs to create a conversational interface that acts as a 24/7 personal career counselor.", techStack: ["OpenAI GPT-4", "Python", "React", "PostgreSQL"], image: "https://images.unsplash.com/photo-1639322537228-f710d846310a?q=80&w=800&auto=format&fit=crop" },
